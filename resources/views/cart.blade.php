                ...
                <div class="col-md-6 offset-3 mt-4" style="box-shadow: rgba(100, 100, 111, 0.2) 0px 7px 29px 0px;">
                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <form method="post" action="{{ route('save.order') }}" class="mx-1 mx-md-4" enctype="multipart/form-data" >
                                @csrf
                                <div class="d-flex flex-row align-items-center mb-4">
                                  <i class="fas fa-user fa-lg me-3 fa-fw"></i>
                                  <div class="form-outline flex-fill mb-0">
                                    <input type="text" name="name" id="name" value="{{ $user->name }}" class="form-control" placeholder="enter your name" value="{{ old('name') }}" />
